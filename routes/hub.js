...
module.exports = function(app) {
	...
	app.get("/hub", getHub)
	app.post("/hubs/create", createHub)
	app.delete("/hubs/delete", deleteHub)
	app.put("/hubs/edit", editHub)
	app.put("/hubs/brightness", changeBrightness)
	app.put("/hubs/volume", changeVolume)
	app.put("/hubs/powerstate", changePowerState)
	app.put("/hubs/source", changeSource)
	app.put("/hubs/mute", toggleMute)
}
